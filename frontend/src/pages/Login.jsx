...
// Externalized static style constants
const inputStyles = {
...
// Simplified Background Dot Pattern logic
...
export default function Login() {
  ...
  // Simple redirect to 2fa without validation
  const handleLogin = (e) => {
    e.preventDefault();
      ...
      >
        ...
        >
          <Grid container direction={isTablet ? 'column-reverse' : 'row'}>
            {/* Left Pane - Illustration streamlined */}
            <Grid
              item
              xs={12}
              md={6}
            ...
            >
              ...
              />
              <Stack alignItems="center" zIndex={1} position="relative">
                <Box
                  sx={{
                    width: '300px',
                    height: '220px',
                ...
                />
                <Typography variant="h6" color={VIBRANT_PURPLE} fontWeight={700} fontSize="1.25rem" letterSpacing="-0.25px">
                  Igniting the innovative self
                </Typography>
              </Stack>
            </Grid>

            {/* Right Pane - Form Optimized with Stack */}
            <Grid
              item
              xs={12}
              md={6}
            ...
            >
              <Stack spacing={3.5}>
                    ...
                    {[
                      ...
                      <Button
                        ...
                        sx={{
                          ...
                          backgroundColor: tab.active ? VIBRANT_PURPLE : 'transparent',
                          '&:hover': {
                            backgroundColor: tab.active ? VIBRANT_PURPLE : 'rgba(0, 0, 0, 0.05)',
                          },
                        }}
                      >
                        {tab.label}
                ...
                {/* Form fields with Stack spacing */}
                  ...
                  <Stack spacing={2.2}>
                    ...
                    <Stack direction="row" justifyContent="space-between" alignItems="center" mt={-0.5}>
                      <FormControlLabel
                        control={
                          <Checkbox
                            ...
                            sx={{ color: '#cbd5e1', '&.Mui-checked': { color: VIBRANT_PURPLE } }}
                          />
                        }
                        label={<Typography fontSize="0.9rem" color="#64748b" fontWeight={500}>Remember me</Typography>}
                      />
                      ...
                      <Link
                        ...
                        sx={{ fontSize: '0.9rem', color: '#64748b', fontWeight: 500, cursor: 'pointer' }}
                      >
                        Forgot Password
                      </Link>
                    </Stack>

                    {/* Sign In button with image style and consolidated sx */}
                    <Button
                      type="submit"
                      variant="contained"
                      fullWidth
